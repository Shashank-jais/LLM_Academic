  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const completedTasks = progressResponse.data.filter(todo => todo.completed).length;
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-blue-600">
                    {academicProgress.questionnairesCompleted}/{academicProgress.totalQuestionnaires}
                  </span>
                </div>
                <div className="flex justify-between items-center">
